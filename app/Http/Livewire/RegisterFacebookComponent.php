...
class RegisterFacebookComponent extends Component
{
    use WithFileUploads;
    ...
    public $subscriptions, $photoId, $photoSelfie, $document, $fbId;

    protected $listeners = [
        'set:latitude-longitude' => 'setLatitudeLongitude'
    ];

    public function mount($fbName, $fbEmail, $fbId)
    {
        $this->email = $fbEmail;
        $this->split_name($fbName);
        $this->fbId = $fbId;
    }
    ...
    {
        $this->subscriptions = StripePayment::all();
        return view('livewire.register-facebook-component');
    }
